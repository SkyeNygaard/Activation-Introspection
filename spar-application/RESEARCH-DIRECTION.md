...
| The model uses its own state better than a cheap outsider can | **Refuted across four task structures.** Model against a four-shot reader, scored at the protocol's own paired unit: content 0.799 vs 1.000, polarity 0.833 vs 1.000, random 0.326 vs 1.000, weak 0.007 vs 0.667. **1 pair** where the model succeeds and the reader fails. **Corrected 2026-08-14:** the earlier entry read "14 episodes in 1728" from single-trial scoring; [notes/22](../activation-introspection/notes/22-the-weak-arm-was-a-floor-not-a-frontier.md) shows those 14 are cells where the model emits one constant label regardless of the edit. Single-trial figures were 0.899/0.917/0.663/0.497 vs 1.000/1.000/1.000/0.833 |
